...
export function ThemeProvider({
  ...
  const presetKey = userThemeStorageKey(STORAGE_PRESET_KEY, userId ?? "anonymous");
  const customizationsKey = userThemeStorageKey(STORAGE_CUSTOMIZATIONS_KEY, userId ?? "anonymous");
