...
import { DotMatrix3Base, rowMajorIndex3 } from "@/shared/ui/visual/dotmatrix/core";
import {
  useCyclePhase,
  useDotMatrixPhases,
  usePrefersReducedMotion,
} from "@/shared/ui/visual/dotmatrix/hooks";
...
export function Dotm3x3_11({
  ...
  const animationResolver = useMemo<DotAnimationResolver>(() => {
    ...
    const currentPattern = GLYPH_PATTERNS[patternIndex] ?? GLYPH_PATTERNS[0];
    const nextPattern = GLYPH_PATTERNS[nextPatternIndex] ?? GLYPH_PATTERNS[0];
