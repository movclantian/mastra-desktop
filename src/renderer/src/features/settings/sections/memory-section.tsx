...
import { fetchMemoryConfig, saveMemoryConfig } from "../api";
import {
      ...
      >
        ...
        {draft.observationalMemory ? (
          <>
            ...
            <div className="flex items-center justify-between gap-4 py-4">
              <div className="min-w-0 space-y-1">
                <p className="text-sm leading-none font-medium">自动记忆预算</p>
                <p className="text-xs text-muted-foreground">
                  自动保留约一半窗口给系统提示、工具和输出,无需手动配置
                </p>
              </div>
              ...
              <>
                ...
                {draft.omRetrieval ? (
                  <>
                    ...
                    <div className="flex items-center justify-between gap-4 py-4">
                      <div className="min-w-0 space-y-1">
                        <p className="text-sm leading-none font-medium">回查范围</p>
                        <p className="text-xs text-muted-foreground">
                          recall 工具检索原始消息的范围,默认跨线程
                        </p>
                      </div>
                      <ScopeSelect
