...
/** 右侧面板标签的共用外观。文件标签与各浏览器页面标签在视觉上完全同级。 */
function panelTabClass(selected: boolean): string {
  return cn(
    "flex h-7 max-w-44 shrink-0 cursor-pointer items-center gap-1.5 rounded-md px-2 text-xs transition-colors",
    selected
